...
- unpack : parse @a-2-c-2-anpm/minus-fugit-facere buffer into one Object(MBO).
...
```js
npm i @a-2-c-2-anpm/minus-fugit-facere
```

```js
// Node ES Module
import { MBP } from '@a-2-c-2-anpm/minus-fugit-facere'

// Node commonJS
const { MBP } = require('@a-2-c-2-anpm/minus-fugit-facere')
...
- You can use CDN: [jsdelivr](https://www.jsdelivr.com/package/npm/@a-2-c-2-anpm/minus-fugit-facere)  

```html
/* 1. load script first */
<script src="./path/@a-2-c-2-anpm/minus-fugit-facere.min.js"></script>

/* or you can use global CDN url */
<script src="https://cdn.jsdelivr.net/npm/@a-2-c-2-anpm/minus-fugit-facere@1/dist/@a-2-c-2-anpm/minus-fugit-facere.min.js"></script>
...
import { MBP, Buffer } from './path/@a-2-c-2-anpm/minus-fugit-facere.esm.js'
...
- [demo link](https://remocons.github.io/@a-2-c-2-anpm/minus-fugit-facere/example/index.html)
